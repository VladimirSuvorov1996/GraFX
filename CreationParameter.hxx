...
namespace graFX::window {
	...
	namespace {
		...
		template<creation_parameter_t parameter>
		class CreationFlag : public CreationParameterBase<parameter> {
		public:
			using base_t = CreationParameterBase<parameter>;
	...
	namespace {
		template<creation_parameter_t parameter>
		class ContextVersion : public CreationParameterBase<parameter> {
		public:
			using base_t = CreationParameterBase<parameter>;
